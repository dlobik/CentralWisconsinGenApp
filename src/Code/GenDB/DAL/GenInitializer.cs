...
namespace GenDB.DAL
{
    public class GenInitializer : DropCreateDatabaseAlways<GenContext>
    {
        protected override void Seed(GenContext context)
        {
            ...
            {
            new Naturalization{FirstName="Bye", LastName="Gogo", DOB="10/10/10", Age=10, DateOfRecord=DateTime.Parse("2001-09-05"), Location="Crangus", CountryOfOrigin="Italy", Series=3, Box=1, Folder=2, VolNumber="3A", PageCertNumber="45", DateOfEntry="20/20/20",PortOfEntry="Washington"},
            new Naturalization{FirstName="Bye", LastName="Gogo", DOB="10/10/10", Age=10, DateOfRecord=DateTime.Parse("2001-09-05"), Location="Crangus", CountryOfOrigin="Italy", Series=3, Box=1, Folder=2, VolNumber="3A", PageCertNumber="45", DateOfEntry="20/20/20",PortOfEntry="Washington"},
            new Naturalization{FirstName="Bye", LastName="Gogo", DOB="10/10/10", Age=10, DateOfRecord=DateTime.Parse("2001-09-05"), Location="Crangus", CountryOfOrigin="Italy", Series=3, Box=1, Folder=2, VolNumber="3A", PageCertNumber="45", DateOfEntry="20/20/20",PortOfEntry="Washington"},
            new Naturalization{FirstName="Bye", LastName="Gogo", DOB="10/10/10", Age=10, DateOfRecord=DateTime.Parse("2001-09-05"), Location="Crangus", CountryOfOrigin="Italy", Series=3, Box=1, Folder=2, VolNumber="3A", PageCertNumber="45", DateOfEntry="20/20/20",PortOfEntry="Washington"},
            new Naturalization{FirstName="Bye", LastName="Gogo", DOB="10/10/10", Age=10, DateOfRecord=DateTime.Parse("2001-09-05"), Location="Crangus", CountryOfOrigin="Italy", Series=3, Box=1, Folder=2, VolNumber="3A", PageCertNumber="45", DateOfEntry="20/20/20",PortOfEntry="Washington"},
