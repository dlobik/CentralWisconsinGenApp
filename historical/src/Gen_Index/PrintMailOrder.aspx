<%@ Page Language="C#" MasterPageFile="~/addins_app/app_child.master" AutoEventWireup="True"  CodeFile="PrintMailOrder.aspx.cs" Inherits="PrintMailOrder" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="mainContent" width=" 100%">
			<table id="mainTable" cellspacing="1" cellpadding="1">
				<tr>
						...
						<table cellspacing="0" border="0">
							<tr>
								...
								<td>
									<table >
										<tr >
											<td align="center" nowrap class="style1">
                                                <asp:Label ID="Label22" runat="server" Text="Central Wisconsin Genealogy Index" 
                                                    Font-Size="18pt" Font-Bold="True" Font-Italic="True"></asp:Label>
											</td>
										</tr>
										<tr >
											<td align="center" colspan="2"><asp:label id="Label16" runat="server" 
                                                    Font-Bold="True" >Mail Order Form</asp:label></td>
										</tr>
										<tr>
											<td align="center" colspan="2">
												<table id="Table2" >
													<tr>
														<td align="center" colspan="2">
                                                            <asp:label id="Label10" runat="server" >Fill out this form, print it and then mail it to the address below:</asp:label></td>
													</tr>
													<tr>
														<td align="center" colspan="2">
                                                            <asp:label id="Label11" runat="server" width="232px" >UW-Stevens Point</asp:label></td>
													</tr>
													<tr>
														<td align="center" colspan="2">
                                                            <asp:label id="Label12" runat="server" >LRC / Archives</asp:label></td>
													</tr>
													<tr>
														<td align="center" colspan="2">
															<asp:label id="Label21" runat="server" >900 Reserve Street</asp:label></td>
													</tr>
													<tr>
														<td align="center" colspan="2">
                                                            <asp:label id="Label13" runat="server" >Stevens Point, WI 54481</asp:label></td>
													</tr>
													<tr><td>&nbsp;</td></tr>
													<tr>
														<td align="center" colspan="2">
                                                            <asp:label id="Label14" runat="server" 
                                                                Font-Bold="True" Font-Underline="True" Font-Italic="True" >Payment must accompany all orders.</asp:label></td>
													</tr>
													<tr>
														<td align="center" colspan="2">
														<asp:Label runat="server" Text="*** Fields in red are required ***" 
				...
				<tr>
					...
					<td><asp:textbox id="txtFirst" runat="server" Width="230px" CssClass="txtBox"></asp:textbox>&nbsp;&nbsp;
				...
				<tr>
					...
					<td><asp:textbox id="txtLast" runat="server" Width="230px" CssClass="txtBox"></asp:textbox>&nbsp;&nbsp;
					<asp:Label runat="server" ID="lblLNameErr" ForeColor="Red" Text="Last name is required." Visible="False"></asp:Label></td>
				</tr>
                <tr>
					<td style="padding-left: 40px;"><asp:label id="Label2" runat="server" ForeColor="Red">Address Line 1*: </asp:label></td>
					<td><asp:textbox id="txtAdd1" runat="server" Width="230px" CssClass="txtBox"></asp:textbox>&nbsp;&nbsp;
					    <asp:Label runat="server" ID="lblAddrErr" ForeColor="Red" Text="Address is required." Visible="False" /></td>
				</tr>
				<tr>
					<td style="padding-left: 40px;"><asp:label id="Label5" runat="server" >Address Line 2: </asp:label></td>
					<td><asp:textbox id="txtAdd2" runat="server" Width="230px" CssClass="txtBox"></asp:textbox></td>
				</tr>
				<tr>
					<td style="padding-left: 40px;"><asp:label id="Label3" runat="server" ForeColor="Red">City*: </asp:label></td>
					<td><asp:textbox id="txtCity" runat="server" Width="230px" CssClass="txtBox"></asp:textbox>&nbsp;&nbsp;
				...
				<tr>
					...
					<td style="font-family: Ariel; font-size: 10pt;"><asp:dropdownlist id="ddlState" runat="server" CssClass="countyDdl">
				...
				<tr>
					...
					<td><asp:TextBox id="txtZip" runat="server" CssClass="txtBox" CausesValidation="True"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
					<asp:Label runat="server" ID="lblZipErr" ForeColor="Red" Text="     Zip code is required." Visible="False"></asp:Label></td>
				</tr>
				<tr>
					<td style="padding-left: 40px;"><asp:label id="Label19" runat="server">Country</asp:label></td>
					<td><asp:dropdownlist id="ddlCountry" runat="server" CssClass="countyDdl" Width="235px">
				...
				<tr>
					<td style="padding-left: 40px;"><asp:label id="Label17" runat="server" Text="Province (if not U.S.):"></asp:label></td>
					<td><asp:TextBox id="txtProvince" runat="server" Width="230px" CssClass="txtBox" CausesValidation="True"></asp:TextBox>&nbsp;&nbsp;
					 <asp:label id="lblProvinceErr" runat="server" ForeColor="Red" Visible="False">  Province is required.</asp:label></td>
				</tr>
				<tr>
					<td style="padding-left: 40px;"><asp:label id="Label15" runat="server" Text="Postal Code (if not U.S.): " Width="200px"></asp:label></td>
					<td><asp:TextBox id="txtPostalCode" runat="server" Width="230px" CssClass="txtBox" CausesValidation="True"></asp:TextBox>&nbsp;&nbsp;
					 <asp:label id="lblPostalCodeErr" runat="server" ForeColor="Red" Visible="False">  Postal code is required.</asp:label></td>
				</tr>
				<tr>
					<td style="padding-left: 40px;"><asp:label id="Label4" runat="server">Email (preferred) </asp:label></td>
					<td><asp:TextBox id="txtEmail" runat="server" Width="230px" CssClass="txtBox"></asp:TextBox>&nbsp;&nbsp;
					<asp:Label runat="server" ID="lblEmailErr" ForeColor="Red" Text="Please enter a valid email address." Visible="False"></asp:Label></td>
				</tr>
				<tr>
					<td style="padding-left: 40px;"><asp:label id="Label9" runat="server" ForeColor="Red">Phone Number*</asp:label></td>
					<td><asp:TextBox id="txtPhone" runat="server" CssClass="txtBox" CausesValidation="True"></asp:TextBox>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
					 <asp:label id="lblPhoneErr" runat="server" ForeColor="Red" Visible="False">  Phone is required.</asp:label></td>
				</tr>
				<tr>
					<td style="padding-left: 40px;"><asp:Label id="Label20" runat="server" >Do you agree to the <br/><a href="termsofservice.aspx" target="_blank"><u>terms of service</u></a>?</asp:Label></td>&nbsp;&nbsp;
								<td> <asp:label id="lblTermsErr" runat="server" Width="406px" ForeColor="Red" Visible="False" Height="19px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    You must agree to continue.</asp:label>
								    <asp:RadioButtonList id="rblAgree" runat="server" RepeatDirection="Horizontal" Height="20px" Width="188px"><asp:ListItem>Yes</asp:ListItem><asp:ListItem selected="true" >No</asp:ListItem></asp:RadioButtonList>
								</td>
				</tr>
								<tr><td>&nbsp;</td> </tr>
				</table>
				...
				<tr>
					<td align="center" style="WIDTH: 502px">
						<asp:GridView ID="gvCart" runat="server" AutoGenerateColumns="false" 
						    AutoGenerateDeleteButton="true" Width="146%" OnRowDeleting="gvCart_OnRowDeleting" 
						    ShowFooter="true" DataKeyNames="GN_ID" Font-Names="Calibri">
                            <AlternatingRowStyle BackColor="WhiteSmoke" />
                            <HeaderStyle BackColor="Cornsilk" Font-Size="X-Small" Font-Names="Verdana" Font-Bold="True" />
                            <FooterStyle BackColor="Cornsilk" Font-Size="X-Small" Font-Names="Verdana" Font-Bold="True" />
			...
			<table>
			  <tr>
					<td align="center">
						<asp:Button id="btnPrint" Text="Print Mail Order Form" OnClick="btnPrint_Click" runat="server" alternateText="Print Form" CssClass="btnBox"></asp:Button>
					</td>
					<td align="center"><asp:Button id="btnSearch" runat="server" Text="Continue Searching" onclick="btnSearch_Click" CssClass="btnBox"></asp:Button>
					</td>
					<%--<td align="center"></td>--%>
				</tr>
			</table>
